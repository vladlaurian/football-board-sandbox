...
| Shot (v20.56.28 result checkpoint; v20.56.29 roll parity) | `SHOT_STARTED`, `SHOT_TARGET_SELECTED`, `SHOT_ROUTE_CONFIRMED`, generic `GAMEPLAY_ROLL_SUBMITTED`, `SHOT_RESOLUTION_DUE` |
