...
This is the authoritative description of the multiplayer model in Sandbox `v20.11.2` / Git package `20.11.2`.
...
## Canonical Gameplay Command Foundation (v20.11.2 / rebuilt Build 2A)
...
## Live Timeline interaction reconciliation (v20.11.2)
